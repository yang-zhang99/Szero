...
import com.me.oauth.domain.entity.BaseOpenApp;
import com.me.oauth.domain.repository.BaseOpenAppRepository;
 ...
 */
@Component
public class BaseOpenAppRepositoryImpl  implements BaseOpenAppRepository {
    /**
     * 登录方式缓存key
     */
