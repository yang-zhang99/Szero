$(document).ready(function () {
  ...
  $('.slide ol li').on('click', function (e) {
    if (!$('.slide ul li').is(":animated")) {
      ...
      if (index > slideIndex) {
        $('.slide ul li').eq(index).stop().animate({ 'z-index': 6, opacity: 1, width: imgWidth, height: 420, top: 0, left: imgWidth }, 0);
        $('.slide ul li').eq(slideIndex).stop().animate({ 'z-index': 6, opacity: 1, width: imgWidth, height: 420, top: 0, left: -imgWidth }, 3 * imgWidth, function () {
          $('.slide ul li').eq(oldSlideIndex).stop().animate({ 'z-index': 1, opacity: 1, width: imgWidth, height: 420, top: 0, left: 0 }, 0);
        });
        $('.slide ul li').eq(index).stop().animate({ 'z-index': 6, opacity: 1, width: imgWidth, height: 420, top: 0, left: 0 }, 3 * imgWidth);
  ...
  function prevYewu() {
    if (!$('.slide ul li').is(":animated")) {
      ...
      if (slideIndex != -1) {
        $('.slide ul li').eq(slideIndex).stop().animate({ 'z-index': 6, opacity: 1, width: imgWidth, height: 420, top: 0, left: -imgWidth }, 0);
        $('.slide ul li').eq(slideIndex + 1).stop().animate({ 'z-index': 6, opacity: 1, width: imgWidth, height: 420, top: 0, left: imgWidth }, 3 * imgWidth, function () {
          $('.slide ul li').eq(slideIndex + 1).stop().animate({ 'z-index': 1, opacity: 1, width: imgWidth, height: 420, top: 0, left: 0 }, 0);
        });
        $('.slide ul li').eq(slideIndex).stop().animate({ 'z-index': 6, opacity: 1, width: imgWidth, height: 420, top: 0, left: 0 }, 3 * imgWidth);
      } else {
        $('.slide ul li').eq($('.slide ul li').length - 1).stop().animate({ 'z-index': 6, opacity: 1, width: imgWidth, height: 420, top: 0, left: -imgWidth }, 0);
        $('.slide ul li').eq(0).stop().animate({ 'z-index': 6, opacity: 1, width: imgWidth, height: 420, top: 0, left: imgWidth }, 3 * imgWidth, function () {
          $('.slide ul li').eq(0).stop().animate({ 'z-index': 1, opacity: 1, width: imgWidth, height: 420, top: 0, left: 0 }, 0);
        });
        $('.slide ul li').eq($('.slide ul li').length - 1).stop().animate({ 'z-index': 6, opacity: 1, width: imgWidth, height: 420, top: 0, left: 0 }, 3 * imgWidth);
  ...
  function nextYewu() {
    if (!$('.slide ul li').is(":animated")) {
      ...
      if (slideIndex != $('.slide ul li').length) {
        ...
        $('.slide ul li').eq(0).stop().animate({ 'z-index': 6, opacity: 1, width: imgWidth, height: 420, top: 0, left: imgWidth }, 0);
        $('.slide ul li').eq(slideIndex - 1).stop().animate({ 'z-index': 6, opacity: 1, width: imgWidth, height: 420, top: 0, left: -imgWidth }, 3 * imgWidth, function () {
          $('.slide ul li').eq(slideIndex - 1).stop().animate({ 'z-index': 1, opacity: 1, width: imgWidth, height: 420, top: 0, left: 0 }, 0);
        });
        $('.slide ul li').eq(0).stop().animate({ 'z-index': 6, opacity: 1, width: imgWidth, height: 420, top: 0, left: 0 }, 3 * imgWidth);
        slideIndex = 0
      }
  ...
  $(function () {
    ...
    data.logoSrc = $templateData.data('') || '/oauth/static/slide/img/logo.svg';
