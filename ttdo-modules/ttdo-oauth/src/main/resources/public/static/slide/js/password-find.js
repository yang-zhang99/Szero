...
$(document).ready(function () {
  ...
  globalData.loginUrl = $templateData.data('loginurl') || '/oauth/static/slide/img/logo.svg';
  ...
  function initInitialData() {
    // storeData.initData.logoSrc = '/oauth/static/slide/img/logo.svg'; // logo 地址
  ...
  $(function () {
    ...
    data.logoSrc = $templateData.data('logosrc') || '/oauth/static/slide/img/logo.svg';
