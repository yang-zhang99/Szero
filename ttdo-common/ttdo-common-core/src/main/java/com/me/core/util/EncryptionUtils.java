package com.me.core.util;

import com.me.core.exception.ContentNotFoundSaltException;
import com.me.core.exception.EncryptionException;
...
public class EncryptionUtils {
    ...
    public static class XOR {
        ...
        public static long generateKey() {
            return ((long) (Math.random() * (MAX_SIZE - MIN_SIZE + 1))) + MIN_SIZE;
        }
