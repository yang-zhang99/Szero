...
import com.yang.redis.RedisQueueHelper;
import com.yang.redis.WlhyRedisProperties;
...
public class HandlerInit implements CommandLineRunner {
    ...
    private final WlhyRedisProperties redisProperties;
    private final RedisQueueHelper redisQueueHelper;

    public HandlerInit(RedisQueueHelper redisQueueHelper, WlhyRedisProperties redisProperties) {
...
//                    ProxyUtils.getUserClass(service).getAnnotation(QueueHandler.class);
