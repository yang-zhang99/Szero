...
public class CustomUserDetails extends User implements Serializable {
    ...
    public CustomUserDetails(String username, String password, Collection<? extends GrantedAuthority> authorities) {
        this(username, password, "P", authorities);
    }

    public CustomUserDetails(@JsonProperty("username") String username, @JsonProperty("password") String password) {
        this(username, password, "P", Collections.emptyList());
    }

    @JsonCreator
    public CustomUserDetails(@JsonProperty("username") String username, @JsonProperty("password") String password, @JsonProperty("userType") String userType) {
    ...
    public void setClientAuthorizedGrantTypes(Collection<String> clientAuthorizedGrantTypes) {
        this.clientAuthorizedGrantTypes = clientAuthorizedGrantTypes == null ? Collections.<String>emptySet() : new LinkedHashSet<String>(clientAuthorizedGrantTypes);
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(userId, that.userId) && Objects.equals(realName, that.realName) && Objects.equals(email, that.email) && Objects.equals(timeZone, that.timeZone) && Objects.equals(language, that.language) && Objects.equals(roleId, that.roleId) && Objects.equals(roleIds, that.roleIds) && Objects.equals(siteRoleIds, that.siteRoleIds) && Objects.equals(tenantRoleIds, that.tenantRoleIds) && Objects.equals(roleMergeFlag, that.roleMergeFlag) && Objects.equals(tenantId, that.tenantId) && Objects.equals(tenantNum, that.tenantNum) && Objects.equals(tenantIds, that.tenantIds) && Objects.equals(imageUrl, that.imageUrl) && Objects.equals(organizationId, that.organizationId) && Objects.equals(isAdmin, that.isAdmin) && Objects.equals(clientId, that.clientId) && Objects.equals(clientName, that.clientName) && Objects.equals(clientAuthorizedGrantTypes, that.clientAuthorizedGrantTypes) && Objects.equals(clientResourceIds, that.clientResourceIds) && Objects.equals(clientScope, that.clientScope) && Objects.equals(clientRegisteredRedirectUri, that.clientRegisteredRedirectUri) && Objects.equals(clientAccessTokenValiditySeconds, that.clientAccessTokenValiditySeconds) && Objects.equals(clientRefreshTokenValiditySeconds, that.clientRefreshTokenValiditySeconds) && Objects.equals(clientAutoApproveScopes, that.clientAutoApproveScopes) && Objects.equals(additionInfo, that.additionInfo) && Objects.equals(apiEncryptFlag, that.apiEncryptFlag);
    }
    ...
    public String toString() {
        return "CustomUserDetails{" + "userId=" + userId + ", username=" + getUsername() + ", realName='" + realName + '\'' + ", email='" + email + '\'' + ", timeZone='" + timeZone + '\'' + ", language='" + language + '\'' + ", roleId=" + roleId + ", roleIds=" + roleIds + ", siteRoleIds=" + siteRoleIds + ", tenantRoleIds=" + tenantRoleIds + ", roleMergeFlag=" + roleMergeFlag + ", tenantId=" + tenantId + ", tenantNum='" + tenantNum + '\'' + ", tenantIds=" + tenantIds + ", imageUrl='" + imageUrl + '\'' + ", organizationId=" + organizationId + ", isAdmin=" + isAdmin + ", clientId=" + clientId + ", clientName='" + clientName + '\'' + ", clientAuthorizedGrantTypes=" + clientAuthorizedGrantTypes + ", clientResourceIds=" + clientResourceIds + ", clientScope=" + clientScope + ", clientRegisteredRedirectUri=" + clientRegisteredRedirectUri + ", clientAccessTokenValiditySeconds=" + clientAccessTokenValiditySeconds + ", clientRefreshTokenValiditySeconds=" + clientRefreshTokenValiditySeconds + ", clientAutoApproveScopes=" + clientAutoApproveScopes + ", additionInfo=" + additionInfo + ", apiEncryptFlag=" + apiEncryptFlag + '}';
    }
    ...
    public String simpleUserInfo() {
        return "CustomUserDetails{" + "userId=" + userId + ", username=" + getUsername() + ", roleId=" + roleId + ", roleIds=" + roleIds + ", siteRoleIds=" + siteRoleIds + ", tenantRoleIds=" + tenantRoleIds + ", roleMergeFlag=" + roleMergeFlag + ", tenantId=" + tenantId + ", tenantIds=" + tenantIds + ", organizationId=" + organizationId + ", isAdmin=" + isAdmin + ", clientId=" + clientId + ", timeZone='" + timeZone + ", language='" + language + '}';
    }
}